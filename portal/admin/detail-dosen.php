...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <?php
                    $query = mysqli_query($db, "SELECT * FROM list_dosen WHERE id='$_GET[kd]' || nama='$_GET[kd]'");
                    ...
                    <tr>
                    <td width="250">NIP</td>
                    <td width="550"><?php echo $data['nip']; ?></td>
                    </tr>
                    <tr>
                    <td>Nama Lengkap</td>
                ...
                <a href="dosen.php" class="btn btn-sm btn-warning"> Kembali <i class="fa fa-arrow-circle-right"></i></a>
                </div>  
                                </div>
                            </div><!-- /.box -->
                        </div>
