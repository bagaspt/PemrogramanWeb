...
<?php } ?>
                ...
                <section class="content">
                    ...
                    ?>
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-mhs.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="nim" type="text" id="nim" class="form-control" placeholder="Ex : 00123" value="<?php echo $data['nim']; ?>" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="nama" type="text" id="nama" class="form-control" placeholder="Nama Lengkap" value="<?php echo $data['nama']; ?>" required />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="prodi" class="form-control" id="prodi" type="text" placeholder="Program Studi" value="<?php echo $data['prodi']; ?>" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nomor Telpon</label>
                              <div class="col-sm-8">
                                  <input name="telp" class="form-control" id="telp" type="text" placeholder="Nomor Telpon" value="<?php echo $data['telp']; ?>" required />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  ...
                                  <img src="<?php echo $data['gambar']; ?>" height="250" width="250" alt="Foto Mahasiswa" style="margin-bottom: 10px;" /><br />
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
	                              ...
	                              <a href="mhs.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
