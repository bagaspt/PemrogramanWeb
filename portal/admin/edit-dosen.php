...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <?php
                    $query = mysqli_query($db, "SELECT * FROM list_dosen WHERE id='$_GET[kd]'");
                    ...
                    ?>
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-buku.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="nip" type="text" id="nip" class="form-control" autocomplete="off" value="<?php echo $data['nip']; ?>" required="" />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="telp" type="text" id="telp" class="form-control" autocomplete="off" value="<?php echo $data['telp']; ?>" required="" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Email</label>
                              <div class="col-sm-8">
                                  <input name="email" type="text" id="email" class="form-control" autocomplete="off" value="<?php echo $data['email']; ?>" required="" />
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  ...
                                  <img src="<?php echo $data['gambar']; ?>" height="250" width="250" alt="Foto Dosen" style="margin-bottom: 10px;" /><br />
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
                                  ...
                                  <a href="dosen.php" class="btn btn-sm btn-danger"> Batal</a>
                              </div>
                          </div>
