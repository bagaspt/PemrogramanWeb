...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <div class="row" style="margin-bottom:5px;">
                        ...
                        <div class="col-md-3">
                            <div class="sm-st clearfix">
                                <span class="sm-st-icon st-green"><i class="fa fa-user" style="color: #ffffff;"></i></span>
                                <div class="sm-st-info">
                                <?php $tampil=mysqli_query($db, "select * from list_mhs order by id desc");
                    ...
                    ?>
                        ...
                        <div class="col-md-3">
                            <div class="sm-st clearfix">
                                <span class="sm-st-icon st-blue"><i class="fa fa-book" style="color: #ffffff"></i></span>
                                <div class="sm-st-info">
                                <?php $tampil=mysqli_query($db, "select * from list_dosen order by id desc");
                    ...
                    ?>
                        ...
                        <div class="col-md-3">
                            <div class="sm-st clearfix">
                                <span class="sm-st-icon st-violet"><i class="fa fa-check-square" style="color: #ffffff"></i></span>
                                <div class="sm-st-info">
                                <?php $tampil=mysqli_query($db, "select * from list_matkul order by id desc");
                    ...
                    ?>
                        ...
                        <div class="col-md-3">
                            <div class="sm-st clearfix">
                                <span class="sm-st-icon st-red"><i class="fa fa-solid fa-lock" style="color: #ffffff"></i></span>
                                <div class="sm-st-info">
                                <?php $tampil=mysqli_query($db, "select * from list_admin order by user_id desc");
