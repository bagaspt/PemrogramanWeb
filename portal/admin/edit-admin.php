...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <?php
                    $query = mysqli_query($db, "SELECT * FROM list_admin WHERE user_id='$_GET[kd]'");
                    ...
                    ?>
                      ...
                      <form class="form-horizontal style-form" action="update-admin.php" method="post" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="nama_lengkap" class="form-control" id="nama_lengkap" type="text" value="<?php echo $data['nama_lengkap'];?>" required />
                              </div>
                          </div>
                          <div class="form-group">
